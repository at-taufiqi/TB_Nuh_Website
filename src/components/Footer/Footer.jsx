        ...
        <Container>
            <Row>
                <Col lg='4' className='mb-4' md='6'>
                    ...
                    <p className="footer__text mt-4">Kunjungi Toko Bangunan Nuh sekarang untuk menemukan material dan peralatan konstruksi yang tepat untuk kebutuhan renovasi atau pembangunan rumah Anda.</p>
                </Col>
                ...
                <Col lg='12'>
                    <p className="footer__copyright">Copyright {year} developed by TB.Nuh Information and Technology Team . All rights reserverd.</p>
                </Col>
            </Row>
        </Container>
    </footer>

                    ...
                    <Row>
                        <Col lg='6' md='6'>
                            <div className="hero__content">
                                <p className="hero__subtitle">Temukan berbagai produk terbaru {year}</p>
                                <h2>Solusi Tepat bagi Anda</h2>
                                <p>Toko Bangunan NUH adalah salah satu toko bangunan terkemuka di kota Purbalingga. Kami menyediakan berbagai jenis material bangunan dan peralatan konstruksi berkualitas tinggi untuk kebutuhan renovasi dan pembangunan rumah Anda.</p>
